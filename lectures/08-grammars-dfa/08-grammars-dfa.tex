...
\begin{frame}{Equivalencias de RGs y FAs}
    ...
    Las \textbf{reglas} de una RG son las \alert{transiciones} de un FA: $X \to \sigma Y = (X,\sigma,Y)$.
...
\begin{frame}{Equivalencias de RGs y FAs}
    ...
    Las \textbf{reglas} de una RG son las \alert{transiciones} de un FA: $X \to \sigma = (X,\sigma,Z)$, donde $Z$ es un único estado final.
