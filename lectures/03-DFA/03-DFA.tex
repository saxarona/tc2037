...
\section{DFA: Las bases}
\label{sec:DFA}

\begin{frame}{Definición}{DFA}
    \begin{definition}
        Un \alert{autómata finito determinista} (DFA por sus siglas en inglés) es una \textbf{quíntupla} de la forma
...
\begin{frame}{Lenguaje aceptado}{DFA}
    Un DFA \alert{acepta} una palabra si al consumir todos sus caracteres llega a uno de sus estados finales (representados con un doble círculo en el diagrama). \pause
...
\section{Diseñando un DFA}
\label{sec:DFA-design}

\begin{frame}{Corrección y Completez}{Diseñando un DFA}
    En ocasiones, el problema radica en construir un DFA a partir del lenguaje que debe aceptar. \pause
...
\begin{frame}{Principios de diseño}{Diseñando un DFA}
...
\begin{frame}{Diseño sistemático}{Diseñando un DFA}
    \begin{enumerate}
        \itemsep1.5ex
...
\begin{frame}{Ejemplo de diseño sistemático}{Diseñando un DFA}
    Un DFA que acepte exactamente el lenguaje en el alfabeto $\{0,1\}$ de palabras que \textbf{no comienzan con 00}. \pause
...
\begin{frame}{Ejemplo de diseño sistemático}{Diseñando un DFA}
    Un DFA que acepte exactamente el lenguaje en el alfabeto $\{0,1\}$ de palabras que \textbf{no comienzan con 00}.
...
\begin{frame}{Diseño por conjuntos de estados}{Diseñando un DFA}
    Un DFA que acepte exactamente el lenguaje en el alfabeto $\{0,1\}$ de palabras que \textbf{tengan $00$ pero no $11$}.
    \begin{center}
        \begin{tikzpicture}[node distance=2.8cm, stylename]
...
\begin{frame}{Subdivisión: diseño por conjuntos de estados}{Diseñando un DFA}
    \begin{itemize}
        \itemsep1.5ex
...
\begin{frame}{Diseño por complemento}{Diseñando un DFA}
...
\begin{frame}{Diseño por complemento}{Diseñando un DFA}
    Obtener un DFA para el lenguaje en $\{a,b\}^*$ de las palabras que \textbf{no contienen la sub-cadena} $\mathbf{abaab}$.
