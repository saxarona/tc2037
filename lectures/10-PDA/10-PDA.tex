...
\section{Descripción informal de un PDA}

\begin{frame}{¿Autómatas de Pila?}{Descripción informal de un PDA}
    Un Autómata de Pila (AP o PDA por sus siglas en inglés) es un Autómata pero con una pila (\textit{stack}). \pause
