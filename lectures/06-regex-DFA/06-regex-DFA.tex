...
\begin{frame}{¿Por qué convertir entre REs y FAs?}{Conversión entre REs y FAs}
    \begin{itemize}
        \itemsep1.5em
        \item Los FAs son más \textbf{fáciles de entender} (y por tanto, de \textbf{diseñar}). \pause
        \item Los FAs son muy \textbf{aparatosos}: describen qué pasa en cada estado y con cada acción. \pause
        \item Las REs son más \textbf{compactas}: sólo describen cómo va a ser el \textit{output} del autómata---el lenguaje de palabras que acepta. \pause
        \item Pasar de una condición de aceptación de un problema a un FA puede ser \textbf{más complicado}. \pause
        \item Explicar una condición de aceptación de un problema, a otra persona mediante una RE puede ser \textbf{muy complicado}.
    \end{itemize}
\end{frame}

\section{De FAs a REs}
...
\begin{frame}{Generalizando}{Conversión entre REs y FAs}
